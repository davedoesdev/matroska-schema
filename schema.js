module.exports = {
  byEbmlID: {
    ...
    0xb3: {
      ...
      multiple: false,
      webm: true,
      description: 'Absolute timestamp of the seek point, expressed in Segment Ticks which is based on TimestampScale; see (#timestamp-ticks).',
      mandatory: true,
      minver: 1,
      crc: false
    },
    ...
    0x55bb: {
      ...
      multiple: false,
      webm: true,
      description: 'The colour primaries of the video. For clarity, the value and meanings for Primaries are adopted from Table 2 of [@!ITU-H.273].',
      mandatory: true,
    ...
    0x63ca: {
      ...
      multiple: false,
      webm: true,
      description: 'An informational string that can be used to display the logical level of the target like "ALBUM", "TRACK", "MOVIE", "CHAPTER", etc.',
    ...
    0x6955: {
      ...
      type: 'u',
      multiple: false,
      description: 'Contains the type of the codec used for the processing. A value of 0 means built-in Matroska processing (to be defined), a value of 1 means the DVD command set is used; see (#menu-features) on DVD menus. More codec IDs can be added later.',
      mandatory: true,
